...
import { updateMessageUI } from "../../../Services/Data/messages/messageSlice";
import { updateMedias } from "../../../Services/Data/mediaSlice";
import { updateFriendData } from "../../../Services/Data/friends/friendSlice";
import { updateAfterReading } from "../../../Services/Data/messages/messagesArraySlice";
...
export default function Userbox({
    ...
    const currentPseudo = useMemo(() => {
        return pseudoList.find(pseudo => pseudo.messageId === messageId);
        // eslint-disable-next-line
    }, [pseudoList]);
